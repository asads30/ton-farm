      ...
      <div class="grid grid-cols-2 gap-x-2 gap-y-9 py-2 relative p-1">
        <router-link to="/store">
          ...
          <div class="flex justify-center self-end home-station">
            <img class="h-44 pb-1 translate-x-1 w-36" :src="info?.shop[0]?.image" />
          </div>
        </router-link>
        <router-link to="/power-station">
          ...
          <div class="flex justify-center self-end">
            <img class="h-44 -translate-x-1" src="@/assets/images/sections/power-station.png" />
          </div>
        </router-link>
        <router-link to="/farm">
          ...
          <div class="flex justify-center self-center">
            <img class="h-44 pb-4" src="@/assets/images/sections/farm.png" />
          </div>
        </router-link>
        <router-link to="/workshop">
          ...
          <div class="flex justify-center self-center">
            <img class="h-44 mx-auto pb-2 pr-1" src="@/assets/images/sections/workshop.png" />
          </div>
        </router-link>
        <div class="home-bg-main">
          <img
            class="w-full h-full object-cover will-change-scroll"
