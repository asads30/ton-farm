<template>
    <main>
        <div class="pb-4 text-center">
          <h2 class="font-pixeboy text-3xl text-white">Farm</h2>
        </div>
        ...
        <div class="grid grid-cols-3 gap-1 py-2">
          <article class="figure-shape">
            <img
              ...
              src="@/assets/images/shapes/hexagon-empty.png"
            />
          </article>
          <article class="figure-shape">
            <img
            ...
            <img
              class="figure-shape--bg"
              src="@/assets/images/shapes/hexagon-with-item.png"
            />
          </article>
          <article class="figure-shape">
            ...
            <img
              class="figure-shape--bg"
              src="@/assets/images/shapes/hexagon-locked.png"
            />
          </article>
          <article class="figure-shape">
            <div class="position-center">
